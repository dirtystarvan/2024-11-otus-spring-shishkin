...
import ru.otus.hw.mongo.mongock.repositories.BlockingAuthorRepository;
import ru.otus.hw.mongo.mongock.repositories.BlockingBookRepository;
import ru.otus.hw.mongo.mongock.repositories.BlockingCommentRepository;
import ru.otus.hw.mongo.mongock.repositories.BlockingGenreRepository;
...
public class MongoChangelog {
    ...
    public void insertAuthors(BlockingAuthorRepository authorRepository) {
    ...
    public void insertGenres(BlockingGenreRepository genreRepository) {
    ...
    public void insertBooks(BlockingBookRepository bookRepository) {
    ...
    public void insertComments(BlockingCommentRepository commentRepository) {
